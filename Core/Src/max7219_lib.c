...
#define cs_set() HAL_GPIO_WritePin(GPIOA, SPI_CS_Pin, 0);         //SPI_CS set; //опускаем ногу CS
#define cs_reset() HAL_GPIO_WritePin(GPIOA, SPI_CS_Pin, 1);         //SPI_CS reset //поднимаем ногу CS
#define _0 0x7E; //0
#define _1 0x30; //1
#define _2 0x6D; //2
#define _3 0x79; //3
...
#define _t 0b00001111; //temperature
#define _H 0b00110111; //humidity
#define _d 0b00111101; //deviation
